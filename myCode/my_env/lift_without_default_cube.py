...
class Lift(ManipulationEnv):
    ...
    def reward(self, action=None):
        ...
        # use a shaping reward
            ...
            # reaching reward
            if self.reward_shaping and self.cube is not None:
            ...
            # grasping reward
            if self.cube is not None and self._check_grasp(gripper=self.robots[0].gripper, object_geoms=self.cube):
                reward += 0.25
    ...
    def _setup_references(self):
        ...
        if self.use_object_obs and self.cube is not None:
    ...
    def visualize(self, vis_settings):
        ...
        if vis_settings["grippers"] and self.cube is not None:
    ...
    def _check_success(self):
        ...
        """
        if self.cube is None or not hasattr(self, "cube_body_id"):
            return False

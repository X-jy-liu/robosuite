...
# Paths
model_path = "/home/s2644572/robosuite/myCode/yolo_perception/runs/detect/mini_train_debug/weights/best.pt"
...
output_img_dir = Path("/home/s2644572/robosuite/myCode/yolo_perception/data/tabletop/test/inference_from_mini_train/images")
pred_txt_dir = Path("/home/s2644572/robosuite/myCode/yolo_perception/data/tabletop/test/inference_from_mini_train/labels")
...
image_paths = sorted([p for p in test_img_dir.glob("*.jpg")] + [p for p in test_img_dir.glob("*.png")])
